...
public class client {
	  ...
	  private static void readOne(String symbol) {
			...
			try {
				boolean result = readContent(symbol, rd, writer);
	   ...
	   */
	  private static boolean readContent(String symbol, BufferedReader rd, BufferedWriter writer) {
			String line = "";
			int count = 0;
			float todayPrice = 1;
			float earlyPrice =1;
			...
			try {
				...
				Quote q = new Quote(symbol, today, todayPrice, day65, earlyPrice, (todayPrice/earlyPrice*100-100));
				quoteSet.add(q);
